...
include_once('dbconnect2.php');
   ...
   if ($option) {
	$query = mysqli_query($conn,"SELECT Drivers.CLIENTIDNO, Drivers.DEPTNO, Drivers.LNAME, Drivers.FNAME, Violations.DRVRVIOL FROM Drivers JOIN Violations ON Drivers.CLIENTIDNO = Violations.CLIENTIDNO WHERE DEPTNO = '$option' ORDER BY CLIENTIDNO");
