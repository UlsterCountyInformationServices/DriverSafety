...
include_once('dbconnect.php');
   ...
   if ($option) {
	$query = mysqli_query($conn,"SELECT PERMITNO AS \"Permit Number\", DEPTNO AS \"Department Number\", FNAME AS \"First Name\", LNAME AS \"Last Name\", CLIENTIDNO, STATUS FROM Drivers WHERE DEPTNO = '$option' ORDER BY PERMITNO ASC");
