...
<div class="topnav">
    ...
    <form action="test_search_remarks_scrpt.php" method=post>
    ...
    <div id="demo" class="collapse">
     <form class="form" action="test_remarks_view.php" method=post> 
...
$sql = "SELECT Drivers.CLIENTIDNO, Drivers.DEPTNO AS \"Department\", Drivers.LNAME AS \"Last Name\", Drivers.FNAME AS \"First Name\", Remarks.DRVRRMKS AS \"Remark\" FROM Drivers, Remarks WHERE Drivers.CLIENTIDNO = Remarks.CLIENTIDNO ORDER BY CLIENTIDNO";
