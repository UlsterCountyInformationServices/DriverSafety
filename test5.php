...
<div class="topnav">
    ...
    <form>
        <input class="button" type="button" value="Add New Record" onclick="window.location.href='test_add_form.php'"/>
    </form>
    ...
    <form>
        ...
        <input class="button" type="button" value="Driver Violations" onclick="window.location.href='test_violations.php'"/>
...
$sql = "SELECT PERMITNO AS \"Permit Number\", DEPTNO AS \"Department Number\", FNAME AS \"First Name\", LNAME AS \"Last Name\", CLIENTIDNO, STATUS from Drivers ORDER BY PERMITNO ASC";
